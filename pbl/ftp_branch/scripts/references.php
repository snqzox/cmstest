...
require_once('admin/scripts/config.php'); 
	...
	while ($row = mysqli_fetch_array($result)){
		...
		$thumbPath =  'http://pblm.cz/Upload/thumb/'.$thumbName;

	echo '<div class="photo-thumb"><a data-lightbox="'.$refid.'" href="' . $path . '"><img src="' . $thumbPath . '" alt="Image"></a></div>';
